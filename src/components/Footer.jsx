        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 hover:text-attorna-gold transition-colors">
          ...
          {/* Column 2 - Contact */}
          <div>
            <h4 className="text-xl font-playfair font-bold mb-6">Contact Info</h4>
          ...
          <div>
            <h4 className="text-xl font-playfair font-bold mb-6">Practice Areas</h4>
            <ul className="space-y-3">
              <FooterLink text="Family Law" />
              <FooterLink text="Business Law" />
              <FooterLink text="Real Estate Law" />
              <FooterLink text="Corporate Law" />
              <FooterLink text="Medical Malpractice" />
...
const FooterLink = ({ text }) => {
  return (
    <li>
      <a href="#" className="text-white/70 hover:text-attorna-gold transition-colors flex items-center">
