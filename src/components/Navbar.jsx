...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top bar */}
      <div className="bg-attorna-darker text-white py-2.5 hidden md:block">
        <div className="container-custom flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-white hover:text-attorna-gold transition-colors">
      ...
      {/* Main navigation */}
      <nav className={`${isScrolled ? 'bg-attorna-darker shadow-lg' : 'bg-transparent'} fixed w-full z-50 transition-all duration-300`}>
        ...
        {/* Mobile menu */}
        <div className={`lg:hidden bg-attorna-darker ${isMenuOpen ? 'block' : 'hidden'}`}>
